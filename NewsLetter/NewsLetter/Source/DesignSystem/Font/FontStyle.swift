...
public enum FontStyle {
    ...
    case jalnanGothic, jalnanGothicSE
    ...
    var font: Font {
        ...
        case .jalnanGothicSE: return Font.custom("Jalnan Gothic", size: 16)
        }
    }
    ...
    var uiFont: UIFont {
        ...
        case .jalnanGothicSE: return UIFont(name: "Jalnan Gothic", size: 16)!
        }
    }
}
